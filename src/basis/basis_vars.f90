...
REAL,ALLOCATABLE,TARGET        :: VdM_visu_GLQuad(:,:)          
REAL,ALLOCATABLE,TARGET        :: D_visu_GLQuad(:,:,:)          
...
REAL,ALLOCATABLE,TARGET        :: VdM_visu_GLHexa(:,:)          
REAL,ALLOCATABLE,TARGET        :: D_visu_Hexa(:,:,:)          
REAL,ALLOCATABLE,TARGET        :: D_visu_GLHexa(:,:,:)          
...
!-----------------------------------------------------------------------------------------------------------------------------------
! NodeType (0:Equidistant, 1: Gauss-Lobatto) 
!-----------------------------------------------------------------------------------------------------------------------------------
INTEGER                     :: CurrentNodeType = 0 
REAL,ALLOCATABLE            :: RefNodeXi(:,:)
REAL,ALLOCATABLE            :: Vdm_AtoB(:,:,:,:)
