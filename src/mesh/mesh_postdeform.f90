...
CASE(35) ! sin 2D xz [-1;1]^2
  x_out(1,:) = x_in(1,:)+ 0.1*SIN(Pi*x_in(1,:))*SIN(Pi*x_in(3,:))
  x_out(2,:) = x_in(2,:)
  x_out(3,:) = x_in(3,:)+ 0.1*SIN(Pi*x_in(1,:))*SIN(Pi*x_in(3,:))
CASE(36) ! sin 2D yz [-1;1]^2
  x_out(1,:) = x_in(1,:)
  x_out(2,:) = x_in(2,:)+ 0.1*SIN(Pi*x_in(2,:))*SIN(Pi*x_in(3,:))
  x_out(3,:) = x_in(3,:)+ 0.1*SIN(Pi*x_in(2,:))*SIN(Pi*x_in(3,:))
